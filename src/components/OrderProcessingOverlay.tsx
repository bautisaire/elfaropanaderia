import "./OrderProcessingOverlay.css";
...
export default function OrderProcessingOverlay({ isOpen, statusText }: Props) {
    if (!isOpen) return null;

    return (
        <div className="order-processing-overlay">
            <div className="order-processing-content">
                <svg className="order-processing-icon" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path d="M34.258,277.584c-0.82-0.683-1.639-1.367-2.46-2.058c-3.039-2.544-7.155-3.509-11.05-2.629
                        ...
                        <path d="M175.648,295.721c-13.825-31.868-27.308-63.812-40.441-95.817c-3.689-9-7.36-18-10.998-27.009
                        ...
                        <path d="M511.352,334.232c-1.23-19.255-11.29-53.258-11.272-53.258l-0.444-1.478c-1.588-3.33-4.662-5.763-8.386-6.6
                        ...
                        <path d="M479.381,255.451c4.799-4.022,5.807-10.819,2.408-15.976c0,0-3.535-6.447-8.966-13.646
                        ...
                        <path d="M374.796,161.171c1.315-3.227,1.263-6.84-0.12-10.033c-1.401-3.185-4.014-5.696-7.275-6.959
                ...
                <p className="order-processing-text">{statusText || 'Confirmando tu pedido...'}</p>
                <p className="order-processing-hint">No cierres esta ventana.</p>
            </div>
        </div>
    );
}
